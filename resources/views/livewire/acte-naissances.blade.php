            ...
            <div class="modal-body d-flex flex-wrap">
                ...
                <div class="col-md-3 p-2"  >
                    <div class="input-group">
                        ...
                        <div class="form-floating ">
                          <input type="file" wire:model='acte_nassance_pere' class="form-control @error('acte_nassance_pere') is-invalid @enderror"    id="floatingInputGroup8" placeholder="Acte de naissance du pere">
                          <label for="floatingInputGroup3">Acte de naissance du pere</label>
                        </div>
                      </div>
                      @error('acte_nassance_pere')
                            <span class="text-danger" role="alert">
                                <strong>{{ $message }}</strong>
                            </span>
                      @enderror
                ...
                <div class="col-md-3 p-2"  >
                    <div class="input-group">
                        {{-- <span class="input-group-text"> <i class="fas fa-user-check"></i> </span> --}}
                        <div class="form-floating ">
                          <input type="file" wire:model='acte_nassance_mere' class="form-control @error('acte_nassance_mere') is-invalid @enderror"    id="floatingInputGroup8" placeholder="Acte de naissance du mere">
                          <label for="floatingInputGroup3">Acte de naissance du mére</label>
                        </div>
                      </div>
                      @error('acte_nassance_mere')
                            <span class="text-danger" role="alert">
                                <strong>{{ $message }}</strong>
                            </span>
                      @enderror
                ...
                <div class="col-md-3">
                    @if ($acte_nassance_mere)
                            <div wire:loading wire:target="photo">Chatgement de l'image...</div>
                            Previsualition de Photo :
                            <img src="{{ $acte_nassance_mere->temporaryUrl() }}" width="150" height="150">
